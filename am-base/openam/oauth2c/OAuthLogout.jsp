<%--
   ...
   Copyright (c) 2011-2020 ForgeRock AS. All rights reserved.
...
<%
   ...
   String logoutForm = ESAPI.encoder().encodeForHTMLAttribute(LOGOUT_FORM);
   String loggedoutParam = ESAPI.encoder().encodeForHTMLAttribute(PARAM_LOGGEDOUT);
   ...
   String logmeoutValue = ESAPI.encoder().encodeForHTMLAttribute(resources.getString("logmeout"));
   String donotValue = ESAPI.encoder().encodeForHTMLAttribute(resources.getString("donot"));
   ...
   if (StringUtils.isNotEmpty(realm)) {
       isValidGotoUrl = AuthD.getAuth().isGotoUrlValid(gotoURL, realm, request)
                    ...
                    <div class="box-content clear-float">
                        <div class="message">
                            ...
                            <div id="logoutMsgVisible">
                                <h3><%= ESAPI.encoder().encodeForHTML(doYouWantToLogout) %></h3>
                            </div>
                        </div>
                        <div id="frame">
                            <noscript>
