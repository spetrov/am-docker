                        ...
                        <div id="loginContent" class="box-content clear-float">
                            ...
                            <jato:content name="validContent">
                                <auth:form name="Login" method="post" defaultCommandChild="DefaultLoginURL">
                                    ...
                                    <input type="hidden" name="SunQueryParamsString" value="<%= ESAPI.encoder().encodeForHTMLAttribute(encodedQueryParams) %>" />
                                    <input type="hidden" name="encoded" value="<%= ESAPI.encoder().encodeForHTMLAttribute(encoded) %>" />
                                </auth:form>
                            </jato:content>
                        </div>
                    </div>
