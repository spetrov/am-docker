    ...
    <head>
        ...
        %>
            ...
            function redirectToWReply () {
                document.location.href="<%=ESAPI.encoder().encodeForJavaScript(wreply)%>";
            } 
        <%
        } else {
        %>
        ...
        <link rel="stylesheet" type="text/css" href="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/com_sun_web_ui/css/css_ns6up.css" />
        <link rel="shortcut icon" href="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/com_sun_web_ui/images/favicon/favicon.ico" type="image/x-icon" />
    </head>
    <body class="DefBdy" onload="startTimer();">
        <div class="SkpMedGry1"><a href="#SkipAnchor3860"><img src="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/com_sun_web_ui/images/other/dot.gif" alt="Jump to End of Masthead" border="0" height="1" width="1"></a></div><div class="MstDiv">
            <table class="MstTblBot" title="" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td class="MstTdTtl" width="99%">
                        <div class="MstDivTtl"><img name="AMConfig.configurator.ProdName" src="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/console/images/PrimaryProductName.png" alt="OpenAM" border="0"></div>
                    </td>
                    <td class="MstTdLogo" width="1%"><img name="AMConfig.configurator.BrandLogo" src="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/com_sun_web_ui/images/other/javalogo.gif" alt="Java(TM) Logo" border="0" height="55" width="31"></td>
                </tr>
            </table>
            <table class="MstTblEnd" border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td><img name="RMRealm.mhCommon.EndorserLogo" src="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/com_sun_web_ui/images/masthead/masthead-sunname.gif" alt="Sun(TM) Microsystems, Inc." align="right" border="0" height="10" width="108" /></td></tr></table>
        </div>
        <table class="SkpMedGry1" border="0" cellpadding="5" cellspacing="0" width="100%"><tr><td><img src="<%= ESAPI.encoder().encodeForHTMLAttribute(deploymentURI) %>/com_sun_web_ui/images/other/dot.gif" alt="Jump to End of Masthead" border="0" height="1" width="1"></td></tr></table>
            ...
            <tr>
                <td>
                  ...
                  %>
                        ...
                        <noscript>
                            <p><a href="<%=ESAPI.encoder().encodeForHTMLAttribute(wreply)%>">Click here</a> to continue</p>
                        </noscript>
                  <%
                    }
                  %>
                  ...
                  %>
                        ...
                        <iframe width="500" src="<%=ESAPI.encoder().encodeForHTMLAttribute(url)%>"></iframe>
                  <%
                    }
                  %>
                </td>
