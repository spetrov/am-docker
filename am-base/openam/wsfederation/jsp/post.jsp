...
<html xmlns="https://www.w3.org/1999/xhtml">
  ...
  <body onLoad="document.forms[0].submit()">
    <form method="POST" action="<%=ESAPI.encoder().encodeForHTMLAttribute(targetURL)%>">
      <input type="hidden" name="wa" value="<%=ESAPI.encoder().encodeForHTMLAttribute(wa)%>">
    <%
    ...
    %>
      <input type="hidden" name="wresult" value="<%=ESAPI.encoder().encodeForHTMLAttribute(wresult)%>">
    </form>
  </body>
