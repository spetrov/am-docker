<%--
   ...
   Portions copyright 2010-2019 ForgeRock AS.
--%>
...
<%
        out.println("<br/>");
        out.println("<a href=" + ESAPI.encoder().encodeForHTMLAttribute(strURL) + ">The data above is generated using the following url</a>");
