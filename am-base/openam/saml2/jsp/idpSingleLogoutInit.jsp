...
<%! private final Logger logger = LoggerFactory.getLogger("jsp.saml2.idpSingleLogoutInit"); %>
    ...
    try {
        ...
        */
        ...
        if (!response.isCommitted()) {
            ...
            if (relayState != null &&
                SAML2Utils.isRelayStateURLValid(metaAlias, relayState, SAML2Constants.IDP_ROLE, true, requestUrl)) {
                response.sendRedirect(relayState);
            } else {
                %>
                <jsp:forward
